  ...
  const {
    ...
    <>
      <MovieDetailModal
        ...
        isFav={selectedMovieModal ? favorites.some((f) => f.title === selectedMovieModal.title) : false}
        onToggleFav={toggleFavorite}
        userRating={selectedMovieModal ? (userRatings[selectedMovieModal.title] || 0) : 0}
        onRate={handleRate}
        onShare={shareOnWhatsApp}
        onSelectMovie={(m) => setSelectedMovieModal(m)}
